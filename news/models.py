...
class Article(Base):
    ...
    category = Column(String(20), nullable=False, comment="板块")
    stock_code = Column(String(20), comment="关联股票代码")
    title = Column(String(500), nullable=False, comment="标题")
    url = Column(String(2048), nullable=False, comment="原文链接")
    url_hash = Column(String(64), nullable=False, comment="url 的 SHA256")
    content = Column(Text, comment="原文内容/摘要")
    dup_count = Column(Integer, default=1, comment="相似文章数量")
